...
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "view.msg", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
...
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  ...
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "App.AlertView", {hash:{
    'contentBinding': ("App.alert.search")
  },contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n        </div>\n    </div>\n    ");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "outlet", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n</div>\n\n<div class=\"row footer\">\n    <div class=\"small-12 columns\">\n        <p>Want to contribute or view the source? Check out the repository <a href=\"https://github.com/makepanic/globe\">on github</a>.</p>\n        <p>Globe is not affiliated with the Tor project.\n        \"Tor\" and the \"Onion Logo\" are registered trademarks of The Tor Project,\n        Inc.</p>\n        <p>Entypo pictograms by Daniel Bruce — <a href=\"http://www.entypo.com/\">www.entypo.com</a>.</p>\n    </div>\n</div>\n");
  return buffer;
...
function program1(depth0,data) {
  ...
  data.buffer.push("\n                    <a title=\"save this graph as image\" class=\"save-as-png entypo\">&#128190;</a>\n                ");
  }
...
function program5(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "view.hasGraph", {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
